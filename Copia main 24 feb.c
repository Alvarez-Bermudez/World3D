...
carregaTextura(texCarasCielo[0],"res/image/world/bajo.bmp");
...
glBegin(GL_QUADS);
glTexCoord2i(0,0);
            glVertex3f(-MUNDO_LARGO,-10,MUNDO_LARGO);
            glTexCoord2i(1,0);
            glVertex3f(MUNDO_LARGO,-10,MUNDO_LARGO);
            glTexCoord2i(1,1);
            glVertex3f(MUNDO_LARGO,-10,-MUNDO_LARGO);
...
glBegin(GL_QUADS);
glTexCoord2i(0,1);
            glVertex3f(-MUNDO_LARGO,-10,MUNDO_LARGO);glTexCoord2i(1,1);
            glVertex3f(-MUNDO_LARGO,-10,-MUNDO_LARGO);glTexCoord2i(1,0);
